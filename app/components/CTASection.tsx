      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="border border-[var(--color-gold)]/20 p-12 md:p-20 rounded-3xl bg-[#0B0B0B]/80 backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="https://wa.me/1234567890" className="w-full sm:w-auto flex items-center justify-center space-x-2 text-white bg-[#25D366]/20 hover:bg-[#25D366]/30 border border-[#25D366]/50 transition-all px-8 py-4 rounded-full font-bold text-lg hover:-translate-y-1 transform">
            ...
            <a href="tel:+1234567890" className="w-full sm:w-auto flex items-center justify-center space-x-2 text-black bg-[var(--color-gold)] hover:bg-[var(--color-gold-hover)] transition-all px-8 py-4 rounded-full font-bold text-lg hover:-translate-y-1 transform">
