  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex items-center min-h-[90vh]">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[#0B0B0B] z-10"></div>
        {/* Subtle glowing orbs */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-30 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <a href="#book" className="w-full sm:w-auto flex items-center justify-center space-x-2 text-black bg-gradient-to-r from-[var(--color-gold)] to-yellow-400 hover:from-[var(--color-gold-hover)] hover:to-[var(--color-gold)] transition-all px-8 py-4 rounded-full font-bold text-lg shadow-[0_0_20px_rgba(212,175,55,0.4)] hover:shadow-[0_0_30px_rgba(212,175,55,0.6)] hover:-translate-y-1 transform">
            <span>Get Celebrity</span>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
            </svg>
          </a>
          <a href="https://wa.me/1234567890" className="w-full sm:w-auto flex items-center justify-center space-x-2 text-white bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 transition-all px-8 py-4 rounded-full font-bold text-lg hover:-translate-y-1 transform">
